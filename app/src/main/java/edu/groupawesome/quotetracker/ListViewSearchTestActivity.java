...
public class ListViewSearchTestActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()) {
            ...
            case android.R.id.home:
                if (viewSwitcher.getNextView() == findViewById(R.id.quote_display) ) {
                    return super.onOptionsItemSelected(item);
                } else {
                    Toast.makeText(this, "Showing list", Toast.LENGTH_SHORT).show();
                    viewSwitcher.setDisplayedChild(viewSwitcher.indexOfChild(findViewById(R.id.quote_search_list)));
                    return true;
                }
...
// use this to change the hint if we change search modes
//     mSearchView.setQueryHint(getString(R.string.search_hint));
    ...
    private void populateListView() {
        ...
        */
        ...
        // add our list of cheeses for the search test
//        mQuotesTitlesList = new ArrayList<>();
//        Collections.addAll(mQuotesTitlesList, mCheeseStrings);
...
//
//                Intent showQuoteIntent = new Intent(ListViewSearchTestActivity.this, QuoteDisplayActivity.class);
//
...
//        });
        ...
        // create a listener to flip views
        mQuotesListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View viewClicked, int position, long id) {

                viewSwitcher.setDisplayedChild(viewSwitcher.indexOfChild(findViewById(R.id.quote_display)));

                // get the textView used to display the title
                TextView quoteTitleView = (TextView) findViewById(R.id.quote_title);
                quoteTitleView.setText(Quote.getQuotesList().get(position).getTitle());

                // get the textView used to display the quote
                TextView quoteTextView = (TextView) findViewById(R.id.quote_text);
                quoteTextView.setText(Quote.getQuotesList().get(position).getQuote());

                // get the textView used to display the tags
                TextView quoteTagsView = (TextView) findViewById(R.id.quote_tags);
                quoteTagsView.setText(Quote.getQuotesList().get(position).getTag());
